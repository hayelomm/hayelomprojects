...
if __name__ == '__main__':
    # Our Dataset with selected features
    dataset = pd.read_csv('combined_Mirai_and_Benign.csv')
    X = dataset.iloc[:, :-1]
    y = dataset.iloc[:, -1]
    ...
    print(f'Training accuracy for our Dataset with selected features: {accuracy_score(y_train, model.predict(X_train))}')
    print(f'Testing accuracy for our Dataset with selected features: {accuracy_score(y_test, model.predict(X_test))}')

    # Our Dataset with full features
    ...
    model = LDTree().fit(X_train, y_train)
    print(f'Training accuracy for our Dataset with full features: {accuracy_score(y_train, model.predict(X_train))}')
    print(f'Testing accuracy for our Dataset with full features: {accuracy_score(y_test, model.predict(X_test))}')
    ...
    model = LDTree().fit(X_train, y_train)
    print(f'Training accuracy for IoTID20 Dataset: {accuracy_score(y_train, model.predict(X_train))}')
    print(f'Testing accuracy for IoTID20 Dataset: {accuracy_score(y_test, model.predict(X_test))}')
